...
public class Users {
    public static void main(String[] args) {
        ...
        try (Connection con = DriverManager.getConnection(dbURL,username,password)){
            ...
            readData(con);
            insertData(con,"kevsyuk","qwerty","Ksenia Evsjuk","k.evsjuk@gmail.com");
    ...
    public static void insertData (Connection con, String username, String password, String fullName, String email) throws SQLException{
        ...
        if (rowsInserted > 0){
            System.out.println("A new user was inserted successfullu");
        }else{
    ...
    public static void deleteData (Connection con, String username) throws SQLException {
        ...
        if (rowsDeleted > 0){
            System.out.println("User was deleted successfullu");
        }else{
            System.out.println("Something went wrong");
        }
